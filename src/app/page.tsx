...
export default function Home() {
  return (
    <>
      {/* <!-- Hero блок --> */}
    <section className="relative py-20 bg-gradient-to-r from-cyan-500 via-cyan-300 to-cyan-500 text-white animate-gradient shadow-[0_4px_6px_-1px_rgba(0,0,0,0.3)]">
        ...
        <div className="container mx-auto px-4 relative z-10 mb-10">
            <div className="max-w-3xl mx-auto text-center">
                <h1 className="text-5xl md:text-5xl font-bold mb-8 animate-fade-in text-shadow-lg">Волонтёры — Элита XXI века</h1>
                <p className="text-2xl mb-12 animate-fade-in animation-delay-200 text-shadow">
                    «Основной мотив моей жизни — сделать что-нибудь полезное для людей,
                    продвинуть человечество хоть немного вперед...»
                </p>
                <p className="text-xl italic mb-12 animate-fade-in animation-delay-400 text-shadow"> К.Э. Циолковский</p>
                <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in mb-20 animation-delay-600">
                    <a href="/404" className="bg-white text-blue-700 px-6 py-3 rounded-lg font-medium hover:bg-blue-50 transition shadow-lg">
                        Подать заявку
                    </a>
                    <a href="/about" className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg font-medium hover:bg-white/10 transition shadow-lg">
                        Узнать больше
                    </a>
                </div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center mt-16 mb-8">
                <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-white/20">
                    <div className="text-4xl font-bold bg-gradient-to-r from-blue-500 to-blue-800 bg-clip-text text-transparent mb-2 animate-fade-in">13 753 000</div>
                    <div className="text-gray-700 font-medium">Волонтёров</div>
                </div>
                <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-white/20">
                    <div className="text-4xl font-bold bg-gradient-to-r from-blue-500 to-blue-800 bg-clip-text text-transparent mb-2 animate-fade-in animation-delay-200">137 080 966</div>
                    <div className="text-gray-700 font-medium">Волонтёрских часов</div>
                </div>
                <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-white/20">
                    <div className="text-4xl font-bold bg-gradient-to-r from-blue-500 to-blue-800 bg-clip-text text-transparent mb-2 animate-fade-in animation-delay-400">112 735</div>
                    <div className="text-gray-700 font-medium">Организаций</div>
                </div>
                <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-white/20">
                    <div className="text-4xl font-bold bg-gradient-to-r from-blue-500 to-blue-800 bg-clip-text text-transparent mb-2 animate-fade-in animation-delay-600">89</div>
                    <div className="text-gray-700 font-medium">Регионов</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-18 text-black">Флагманские проекты фонда</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <p className="text-gray-600 mb-4">
                            Премия «Благородное сердце», конкурс «Поступок года»
                        </p>
                        {/* <a href="/404" className="text-blue-600 font-medium flex items-center">
                            Подробнее 
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-1"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                    <div className="h-48 bg-purple-100 flex justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-line-chart text-purple-500"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg>
                    </div>
                    <div className="p-6">
                        <h3 className="text-xl font-bold mb-3 text-black">Рейтинг и статус</h3>
                        <p className="text-gray-600 mb-4">
                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                    <div className="h-48 bg-emerald-100 flex justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-megaphone text-emerald-500"><path d="m3 11 18-5v12l-18-5z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/></svg>
                    </div>
                    <div className="p-6">
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div className="bg-white p-6 rounded-lg shadow-sm flex items-center justify-center h-24">
                    <div className="text-2xl font-bold text-red-700">РЖД</div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm flex items-center justify-center h-24">
                    <div className="text-2xl font-bold text-blue-400">Газпром</div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm flex items-center justify-center h-24">
                    <div className="text-2xl font-bold text-blue-600">ВТБ</div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm flex items-center justify-center h-24">
                    <div className="text-2xl font-bold text-gray-400">Роскосмос</div>
                </div>
            </div>
    ...
    {/* <!-- Призыв к действию --> */}
    <section className="py-20 bg-gradient-to-r from-cyan-500 via-cyan-400 to-cyan-500 text-white animate-gradient shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.3)]">
        <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="/about" className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-medium hover:bg-white/10 transition shadow-lg">
                    Узнать больше
                </a>
            </div>
        </div>
